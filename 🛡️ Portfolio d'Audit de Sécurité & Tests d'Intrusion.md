...
- [1. Audit d'Infrastructure via Pipeline DevOps](#3-compromission-dinfrastructure-via-pipeline-devops-environnement-build)
- [2. Audit d'Infrastructure Active Directory ](#1-audit-dinfrastructure-active-directory-environnement-vulncicada)
- [3. Audit de Sécurité d'Intranet ](#2-audit-de-sécurité-dintranet-environnement-redcross)
